...
- :green_square: Agrega la MEF del encoder, juntos a sus pines correspondientes
...
- :green_square: Agrega la libreria tick.h junto a tick.c para utilizar el Timer0 y contadores con el mismo
- :green_square: Agrega otra MEF para el ENCODER, correspondiente a la tecla del mismo
...
- :green_square: Se agregaron las librerias con las MEF del ENCODER para organizar de manera modular